    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          return _context.abrupt("return", svgString);
        case 11:
          throw new Error("HTTP response code: ".concat(response.status));
        case 12:
          _context.next = 18;
          break;
        case 14:
          ...
          console.error("Error fetching SVG: ".concat(_context.t0.message));
          throw _context.t0;
        case 18:
        case "end":
